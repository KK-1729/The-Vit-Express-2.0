...
<body>
    ...
    <div id="top">
        <div class="jumbotron">
            <h1 class="display-4">Have something spicy to share?</h1>
            <p class="lead">
                    <?php
                        if( empty($_SESSION['user']) )
                            echo '<a class="btn btn-lg" href="login.php" role="button">Share<i class="fas fa-arrow-right"></i></a>';
                        else
                            echo '<a class="btn btn-lg" href="newspost_form.php" role="button">Share<i class="fas fa-arrow-right"></i></a>';
                    ?>
            </p>
        </div>
    ...
    <div id="news" style="margin-left:-50px;">
        <div class="rumour">
            ...
            <?php
                $i = 1;
                $sql = "select * from posts where approval=1 and class='Rumour' order by post_id DESC";
        ...
        <div class="headlines" style="margin-left:-20px;margin-top:25px;">
            ...
            <?php
                $i = 1;
                $sql = "select * from posts where approval=1 and class='Headline' order by post_id DESC";
                $result = mysqli_query($conn,$sql);
                $num = mysqli_num_rows($result);
                if($num == 0) {
                    echo '<h4 align="center" class="card card-title">No Content have been Approved Yet</h4>';
